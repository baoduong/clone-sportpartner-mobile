$.emojiarea.path = '../../images/emoticons';
$.emojiarea.icons = [{
    "name": "<i class='icon-smile'></i>", "icons": {
        ':bowtie:': 'bowtie.png',
        ':smile:': 'smile.png',
...
{
    'name': '<i class="icon-tree"></i>', 'icons': {
        ':sunny:': 'sunny.png',
...
{
    'name': '<i class="icon-bell-alt"></i>', 'icons': {
...
{
    'name': '<i class="icon-location"></i>', 'icons': {
        ':corn:': 'corn.png',
        ':house:': 'house.png',
...
{
    'name': '<i class="icon-dollar"></i>', 'icons': {
        ':one:': 'one.png',
        ':two:': 'two.png',
        ':three:': 'three.png',
        ':four:': 'four.png',
